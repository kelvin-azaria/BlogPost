...
class ApiPostCommentsTest extends TestCase
{
    ...
    public function testNewBlogPostDoesNotHaveComments()
    {
        ...
        $response = $this->json('GET','api/v1/posts/1/comment');
    ...
    public function testBlogPostHas10Comments(){
        ...
        $response = $this->json('GET','api/v1/posts/2/comment');
    ...
    public function testAddingCommentsWhenNotAuthenticated()
    {
        ...
        $response = $this->json('POST','api/v1/posts/3/comment',[
            'content' => 'Hello'
        ]);
    ...
    public function testAddingCommentsWhenAuthenticated()
    {
        ...
        $response = $this->actingAs($this->user(),'api')->json('POST','api/v1/posts/4/comment',[
            'content' => 'Hello'
        ]);
    ...
    public function testAddingCommentWithInvalidData()
    {
        ...
        $response = $this->actingAs($this->user(),'api')->json('POST','api/v1/posts/5/comment',[
